...
$(shell mkdir -p $(PRODUCT_OUT)/obj/PACKAGING/target_files_intermediates/lineage_S25_mini-target_files-$(TARGET_BUILD_VARIANT).hackerdude/VENDOR/lib)
$(shell rm -f $(PRODUCT_OUT)/obj/PACKAGING/target_files_intermediates/lineage_S25_mini-target_files-$(TARGET_BUILD_VARIANT).hackerdude/VENDOR/lib/libwifi-hal.so)
$(shell rm -f $(PRODUCT_OUT)/obj/PACKAGING/target_files_intermediates/lineage_S25_mini-target_files-$(TARGET_BUILD_VARIANT).hackerdude/VENDOR/lib/libtinycompress.so)
